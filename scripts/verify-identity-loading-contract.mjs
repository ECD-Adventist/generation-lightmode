...
const checks = [
  ...
  ["Post hydrates from feed cache", read("src/pages/Post.jsx").includes('getQueryData(["allGlowDrops"])')],
  ...
  ["offline cache beats unresolved empty live page", read("src/hooks/useOfflineSync.js").includes("liveDrops?.length > 0 ? liveDrops : cachedDrops")],
