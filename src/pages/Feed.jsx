        ...
        >
           ...
           <nav className="flex flex-col gap-1 flex-1">
             ...
             <button
               ...
               style={{ color: "#3A4A6B" }}
             >
               <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 text-sm" style={{ background: "#FFFFFF", border: "1px solid #D6E4FF" }}>📚</div>
             ...
             <button
               ...
               style={{ color: "#3A4A6B" }}
             >
               <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: "#FFFFFF", color: "#5A6A8A", border: "1px solid #D6E4FF" }}>
          ...
          <div className="fixed inset-0 z-[100] lg:hidden">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-72 border-r flex flex-col py-8 px-6 overflow-y-auto" style={{ background: "linear-gradient(165deg, #F0FAF3 0%, #D6F5DE 40%, #C8F2D4 75%, #B8EDCA 100%)", borderColor: "#A0E0B0" }}>
              ...
              <nav className="flex flex-col gap-1 flex-1">
                ...
                <button onClick={() => setIsMoreOpen(v => !v)} className="group flex items-center gap-3 px-3 py-2.5 rounded-xl transition w-full text-left mt-4 hover:bg-white/40" style={{ color: "#4A5878" }}>
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: "#FFFFFF", border: "1px solid #D6E4FF" }}>
                    <Settings className="w-[16px] h-[16px]" />
                  </div>
                  <span className="text-sm font-semibold flex-1">More</span>
                  <ChevronRight className={`w-3.5 h-3.5 transition-transform ${isMoreOpen ? "rotate-90" : ""}`} style={{ color: "#8A97B5" }} />
