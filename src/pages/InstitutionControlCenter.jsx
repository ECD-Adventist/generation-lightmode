...
import InteractiveTerritoryMap from "@/components/institution/InteractiveTerritoryMap";
          ...
          <div className="max-w-6xl mx-auto">
            {activeTab === "dashboard" && (
              <div className="space-y-6">
                <InteractiveTerritoryMap institutionApps={institutionApps} ownerEmail={user.email} />
              </div>
            )}
