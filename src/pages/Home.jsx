  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"} style={{ background: "#0B0F1A" }}>
      ...
      <section className="pt-[86px] px-6 pb-20" style={{
        ...
        {/* Dark overlay — gentle bottom fade only */}
        <div style={{
          position: "absolute", inset: 0,
          background: "linear-gradient(180deg, rgba(11,15,26,0.2) 0%, rgba(11,15,26,0.15) 40%, rgba(11,15,26,0.85) 85%, rgba(11,15,26,1) 100%)",
          pointerEvents: "none",
        }} />
