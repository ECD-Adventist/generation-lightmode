        ...
        <div className="p-6">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm mt-1" style={{ color: "#6B7FA0" }}>
                This will permanently remove your profile, posts, comments, prayer requests, and activity. This action cannot be undone.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-xl p-3 mb-4 text-sm" style={{ background: "#FEF2F2", border: "1px solid #FECACA", color: "#991B1B" }}>
            ...
            <ul className="list-disc pl-5 space-y-0.5 text-[13px]">
              <li>Your content will be marked for deletion immediately.</li>
              <li>Our team verifies and completes removal within 30 days.</li>
              <li>You'll be signed out after confirming.</li>
            </ul>
          </div>
