...
export default function CodesOfTruthPoster({ text, verse, className = "" }) {
  ...
  const bodyFontSize = len > 260 ? "clamp(9px, 3.1cqw, 22px)"
    : len > 180 ? "clamp(10px, 3.5cqw, 25px)"
    : len > 120 ? "clamp(11px, 4cqw, 28px)"
    : len > 60 ? "clamp(12px, 4.6cqw, 32px)"
    : "clamp(14px, 5.8cqw, 40px)";
          ...
          <div className="mb-2 max-w-[26ch]">
            <div
              ...
              style={{
                ...
                fontSize: "clamp(7px, 2.3cqw, 15px)",
            ...
            {verseParts.quote && (
              <div
                ...
                style={{
                  color: "#FFD000",
                  fontSize: "clamp(7px, 2.6cqw, 17px)",
