...
// Global CSS injected once — provides utility classes (.adm-card, .adm-hero, etc.)
// keyed to `data-admin-theme` on <html>.
...
// Inject global admin CSS once on the client
if (typeof document !== "undefined" && !document.getElementById("admin-theme-global-css")) {
  const style = document.createElement("style");
  style.id = "admin-theme-global-css";
  style.textContent = ADMIN_GLOBAL_CSS;
