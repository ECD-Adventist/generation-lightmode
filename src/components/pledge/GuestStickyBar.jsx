...
export default function GuestStickyBar() {
  ...
  return (
    <div
      className="fixed z-[5000] px-3 sm:px-5 py-2.5 flex items-center justify-between gap-3 rounded-2xl"
      style={{
    ...
    >
      ...
      <button
        onClick={signIn}
        className="relative z-10 shrink-0 rounded-full px-4 sm:px-5 py-2.5 min-h-11 text-[13px] sm:text-sm font-black transition active:scale-95 hover:opacity-90 whitespace-nowrap cursor-pointer touch-manipulation"
