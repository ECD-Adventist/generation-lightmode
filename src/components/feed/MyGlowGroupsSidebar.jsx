...
export default function MyGlowGroupsSidebar({ userEmail }) {
  ...
  const visibleGroups = userEmail ? myGroups : allGroups.filter(g => (g.privacy || "public") === "public");
  ...
  return (
    <div className="mt-4">
      <div className="flex items-center justify-between px-3 mb-2">
        <p className="text-[10px] font-bold uppercase tracking-[0.15em]" style={{ color: "#90A4AE" }}>{userEmail ? "My Groups" : "Public Groups"}</p>
