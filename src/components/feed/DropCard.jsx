          ...
          <div className="flex flex-col items-center gap-1 sm:gap-1.5">
            <button
              ...
              style={drop.media_url
                ...
                : { background: "rgba(255,255,255,0.85)", border: "1px solid #D6E4FF", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}
              title={userHasLiked ? "Unlike this drop" : "Like this drop"}
            >
              <Heart className={`w-5 h-5 sm:w-6 sm:h-6 transition-all ${likeBurst ? 'dc-anim-like' : ''} ${userHasLiked ? "text-red-500 fill-red-500 drop-shadow-[0_0_8px_rgba(239,68,68,0.6)]" : drop.media_url ? "text-white hover:scale-110" : "text-[#1E5AFF] hover:scale-110"}`} />
            </button>
          ...
          <div className="flex flex-col items-center gap-1 sm:gap-1.5">
            <button
              ...
              style={drop.media_url
                ...
                : { background: "rgba(255,255,255,0.85)", border: "1px solid #D6E4FF", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}
            >
              <MessageCircle className={`w-5 h-5 sm:w-6 sm:h-6 transition-transform hover:scale-110 ${commentBounce ? 'dc-anim-bounce' : ''}`} style={{ color: showComments ? "#1FB8FF" : drop.media_url ? "#FFFFFF" : "#1E5AFF" }} />
            </button>
          ...
          <div className="flex flex-col items-center gap-1 sm:gap-1.5">
            <button
              ...
              style={drop.media_url
                ...
                : { background: "rgba(255,255,255,0.85)", border: "1px solid #D6E4FF", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}
            >
              <Share2 className={`w-5 h-5 sm:w-6 sm:h-6 transition-transform hover:scale-110 ${sharePulse ? 'dc-anim-bounce' : ''}`} style={{ color: drop.media_url ? "#FFFFFF" : "#1E5AFF" }} />
            </button>
          ...
          <div className="flex flex-col items-center gap-1 sm:gap-1.5">
            <button
              ...
              style={drop.media_url
                ...
                : { background: "rgba(255,255,255,0.85)", border: "1px solid #D6E4FF", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}
            >
              <Bookmark className={`w-5 h-5 sm:w-6 sm:h-6 transition-transform hover:scale-110 ${saveBounce ? 'dc-anim-bounce' : ''} ${isSaved ? "fill-[#FFD60A]" : ""}`} style={{ color: isSaved ? "#FFD60A" : drop.media_url ? "#FFFFFF" : "#1E5AFF" }} />
            </button>
          </div>
              ...
              <DropdownMenuTrigger asChild>
                <button
                  ...
                  style={drop.media_url
                    ...
                    : { background: "rgba(255,255,255,0.85)", border: "1px solid #D6E4FF", boxShadow: "0 2px 8px rgba(0,0,0,0.06)" }}
                >
                  <MoreHorizontal className="w-4 h-4" style={{ color: drop.media_url ? "#FFFFFF" : "#1E5AFF" }} />
                </button>
              </DropdownMenuTrigger>
