...
export default function DropCard({ drop, user, dropUser, likeMutation, handleShare, userLikes = [] }) {
  ...
  return (
    <div className="bg-[#121826]/80 backdrop-blur-sm border border-white/10 rounded-[2rem] mb-8 p-3 shadow-2xl hover:border-[#00CFFF]/40 transition-all duration-300 group">
      {/* Media / Content Area */}
      <div 
        className={`relative w-full rounded-[1.5rem] overflow-hidden ${drop.media_url ? 'aspect-auto max-h-[600px]' : ''} bg-gradient-to-br from-[#1a1b26] via-[#0B0F1A] to-[#1a103c] flex flex-col justify-center items-center text-center shadow-inner`}
