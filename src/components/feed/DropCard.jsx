  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: drop.media_url ? "linear-gradient(135deg, #F0FAF3 0%, #E8F5C8 60%, #C8F2D4 100%)" : "#03091f" }}
        onDoubleClick={() => {
          setLikeBurst(true);
          setTimeout(() => setLikeBurst(false), 600);
          likeMutation.mutate({ id: drop.id, authorEmail: drop.user_email, authorName: getDisplayName(dropUser) });
      ...
      >
        ...
        {!drop.media_url && (
          <BrandedVerseCard verse={drop.verse} reflection={cleanReflection(drop.reflection)} />
        )}
        ...
        {(() => {
          // Text posts use the dark branded card treatment.
          const useGlass = true;
          return (
