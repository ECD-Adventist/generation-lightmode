      ...
      >
        ...
        {!drop.media_url && (
          <>
            ...
            <div className={`p-4 sm:p-8 pr-14 sm:pr-20 relative z-10 w-full h-full flex flex-col items-center ${isKeepIt100 ? "justify-center pt-[8%] pb-[44%]" : "justify-center"} ${isLeaderPost ? "py-10 sm:py-14" : ""}`}>
              {isKeepIt100 ? (
