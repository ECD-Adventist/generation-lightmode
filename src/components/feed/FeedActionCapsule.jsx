...
export default function FeedActionCapsule({ children, more, inline = false }) {
  return (
    <div className={`${inline ? "relative px-0.5" : "absolute left-2.5 right-2.5 bottom-4"} z-30 flex items-center gap-2 pointer-events-none`} onClick={(event) => event.stopPropagation()}>
