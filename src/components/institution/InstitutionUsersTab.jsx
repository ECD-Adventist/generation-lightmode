                ...
                {filteredUsers.map(user => {
                  ...
                  return (
                    <tr key={user.email} className="hover:bg-white/[0.02] transition">
                      ...
                      <td className="px-6 py-4 font-semibold text-[#FFD000]">
                        {user.glow_score || 0}
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <Link to={createPageUrl("Profile") + `?user=${encodeURIComponent(user.email)}`} className="text-xs font-bold text-[#00CFFF] hover:underline">
                          View Profile
                        </Link>
                      </td>
                    </tr>
