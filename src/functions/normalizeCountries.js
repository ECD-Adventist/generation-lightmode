...
// Normalize a country string: trim whitespace, fix known aliases
function normalizeCountry(country) {
  ...
  // Known aliases / translations → canonical English name
  const aliases = {
    ...
    "Ethiopie": "Ethiopia",
    "Éthiopie": "Ethiopia",
    "Burundi (Republic)": "Burundi",
    "Rwanda (Republic)": "Rwanda",
  };
